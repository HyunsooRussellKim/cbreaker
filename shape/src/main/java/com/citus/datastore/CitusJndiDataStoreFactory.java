...
public class CitusJndiDataStoreFactory extends OracleNGJNDIDataStoreFactory  
{
    ...
    public CitusJndiDataStoreFactory()
    {
    ...
    public static synchronized JDBCDataStore getDefaultStore(Map params) throws IOException
    {
    	...
    	{
    		defaultStore = new CitusJndiDataStoreFactory().createDataStore(params);
