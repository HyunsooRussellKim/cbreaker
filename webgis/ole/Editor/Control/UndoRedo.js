...
OpenLayers.Editor.Control.UndoRedo = OpenLayers.Class(OpenLayers.Control, {
    ...
    initialize: function(layer, options) {
        ...
        this.layer.events.register('featuremodified', this, this.register);
    ...
    deactivate: function() {
        //this.layer.events.unregister('featureadded', this, this.register);
        this.layer.events.unregister('afterfeaturemodified', this, this.register);
        this.layer.events.unregister('featuremodified', this, this.register);
    },
