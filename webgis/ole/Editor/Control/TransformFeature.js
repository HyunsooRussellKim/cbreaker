...
OpenLayers.Editor.Control.TransformFeature = OpenLayers.Class(OpenLayers.Control.TransformFeature, {
    ...
    addStyles: function(){
        ...
        this.editLayer.styleMap.styles.rotate = new OpenLayers.Style({
            ...
            externalGraphic: citus.WebGIS.prototype.webgisPrefix + 'images/symbol_rotate.png',
            graphicWidth:23,
            graphicHeight:22
        }, {
            context: {
    ...
    deactivate: function () {
        this._moving = true;
        if(this.box.geometry!=null) this.box.geometry.rotate(-this.rotation, this.center);
        delete this._moving;
