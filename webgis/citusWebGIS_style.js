...
(function() {
    ...
    var $WebGIS_proto = {
        ...
        options: {
            url: {
                webgis: 'http://localhost:8080/citus/webgis/',
                shape: 'http://localhost:8080/shape/'
            },
            basemap: {
    ...
    var $WebGIS = function(element, options) {
        ...
        this.init = function() {
            ...
            */
            ...
            if (this.options.basemap.source === 'localmap') {
                this.map.addLayers([
                    new OpenLayers.Layer.WMS('geoserver', this.options.basemap.url + '/CITUS/wms', {
        ...
        */
        ...
        this.startEditing = function(layerName, options) {
            ...
            editLayer.events.register('featureadded', this, this.onFeatureAdded);
            editLayer.events.register('afterfeaturemodified', this, this.onFeatureModified);
            editLayer.events.register('featuredeleted', this, this.onFeatureDeleted);
            editLayer.events.register('featuresremoved', this, this.onFeaturesRemoved);
            this.editorToolbar.controls[11].events.register('dragcomplete', this, this.onFeatureModified);
        ...
        this.setSnaping = function(layerName, tolerance) {
            var layer = this.map.getLayersByName(layerName)[0];
            var meter = this.editorToolbar.controls[1].snapping.getGeoTolerance(tolerance, this.map.resolution);
        ...
        this.undo = function() {
            this.controlUndoRedo().undo();
        };

        this.redo = function() {
            this.controlUndoRedo().redo();
        };
